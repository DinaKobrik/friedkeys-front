...
const headingStyles = {
  ...
  h2: `${baseStyles} uppercase font-usuzi-condensed text-[20px] leading-[24px] sm:text-[38px] sm:leading-[44px] `,
  h3: `${baseStyles} uppercase font-usuzi-condensed text-[16px] leading-[16px] sm:text-[26px] sm:leading-[28px]`,
};
