...
const GameActivationSection: React.FC = () => {
  ...
  useEffect(() => {
    const loadOrder = async () => {
      ...
      if (orderData) {
        ...
        orderData.date = date.toLocaleDateString("ru-RU").replace(/\./g, "/");
        orderData.paymentMethod = orderData.paymentMethod.toLowerCase();
      }
...
export default GameActivationSection;
