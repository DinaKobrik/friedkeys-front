...
const GameList: React.FC = () => {
  ...
  return (
    <div className="game-list mt-[24px] sm:mt-[56px] relative">
      ...
      {totalPages > 1 && (
        <div className="grid justify-items-center justify-center items-center grid-cols-[repeat(auto-fit,40px)] sm:grid-cols-[repeat(auto-fit,75px)] gap-[18px] my-0 mx-auto">
          {totalPages > 5 &&
            (currentPage === 1 ? (
              <>
