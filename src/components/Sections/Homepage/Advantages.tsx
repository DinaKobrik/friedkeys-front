    ...
    <div className="advantages__wrapper my-[56px] md:my-[120px]">
      <div className="w-full overflow-hidden">
        <div className="advantages w-[calc(100%+200px)] overflow-hidden px-0 sm:py-[88px] mx-auto flex justify-center z-10">
          <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center max-w-[20%] pr-[50px] pl-[16px] xl:pr-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-5">
            <svg
          ...
          <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center max-w-[20%] px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-4">
            <svg
              className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
              width="65"
              height="64"
          ...
          <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center max-w-[20%] px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-3">
            <svg
              className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
              width="64"
              height="65"
          ...
          <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center max-w-[20%] px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-2">
            <svg
              className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
              width="65"
              height="64"
          ...
          <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center max-w-[20%] pl-[50px] pr-[16px] xl:pl-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-1">
            <svg
              className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
              width="64"
              height="64"
