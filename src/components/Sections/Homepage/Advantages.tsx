...
//         <div className="advantages w-[calc(100%+200px)] overflow-hidden px-0 sm:py-[88px] mx-auto flex justify-center z-10">
//           <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center pr-[50px] pl-[16px] xl:pr-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-5">
//             <svg
//               className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//               width="64"
//               height="64"
//               viewBox="0 0 64 64"
//               fill="none"
...
//               />
//             </svg>
//             <span className="text-center text-white text-[14px] leading-[18px] sm:text-[24px] sm:leading-[30px] ">
//               A huge selection of games for PC and consoles
//             </span>
//           </div>
//           <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-4">
//             <svg
//               className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//               width="65"
//               height="64"
...
//             </svg>
//             <span className="text-center text-white text-[14px] leading-[18px] sm:text-[24px] sm:leading-[30px] ">
//               Instant key delivery 24/7
//             </span>
//           </div>
//           <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-3">
//             <svg
//               className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//               width="64"
//               height="65"
...
//             </svg>
//             <span className="text-center text-white text-[14px] leading-[18px] sm:text-[24px] sm:leading-[30px] ">
//               Great prices and regular discounts
//             </span>
//           </div>
//           <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center px-[50px] xl:px-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-2">
//             <svg
//               className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//               width="65"
//               height="64"
...
//             </svg>
//             <span className="text-center text-white text-[14px] leading-[18px] sm:text-[24px] sm:leading-[30px] ">
//               Only official and licensed games
//             </span>
//           </div>
//           <div className="advantage w-full flex flex-col gap-[16px] items-center justify-center pl-[50px] pr-[16px] xl:pl-[75px] py-[45px] sm:pt-[45px] sm:pb-[16px] bg-advantages relative z-1">
//             <svg
//               className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//               width="64"
//               height="64"
...
//     <div className="advantages__wrapper my-[56px] md:my-[120px]">
//       <div className="w-full overflow-hidden">
//         <div className="advantages w-[calc(100%+150px)] relative  left-[-75px] overflow-hidden px-0 sm:py-[88px] mx-auto grid gap-[8px] sm:gap-[25px] z-10">
//           <div className="bg-advantages skew-x-[20deg] w-full ">
//             <div className="w-full flex flex-col gap-[16px] items-center justify-center skew-x-[-20deg] relative px-[40px] pl-[85px] 2xl:px-[30px] 2xl:pl-[90px] py-[25px] sm:py-[45px] sm:pt-[45px] sm:pb-[16px] z-5">
//               <svg
//                 className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//                 width="64"
//                 height="64"
...
//           </div>
//           <div className="bg-advantages skew-x-[20deg] w-full ">
//             <div className="w-full flex flex-col gap-[16px] items-center justify-center skew-x-[-20deg] relative px-[25px] sm:px-[40px] pr-[85px] 2xl:px-[70px] xl:pr-[40px] py-[25px] sm:py-[45px] sm:pt-[45px] sm:pb-[16px] z-5">
//               <svg
//                 className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//                 width="65"
//                 height="64"
...
//             </div>
//           </div>
//           <div className="bg-advantages skew-x-[-20deg] xl:skew-x-[20deg] w-full ">
//             <div className="w-full flex flex-col gap-[16px] items-center justify-center skew-x-[20deg] xl:skew-x-[-20deg] relative px-[25px] sm:px-[40px] pl-[85px] xl:px-[70px] 2xl:pl-[40px] py-[25px] sm:py-[45px] sm:pt-[45px] sm:pb-[16px] z-5">
//               <svg
//                 className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//                 width="64"
//                 height="65"
...
//           </div>
//           <div className="bg-advantages skew-x-[-20deg] xl:skew-x-[20deg] w-full ">
//             <div className="w-full flex flex-col gap-[16px] items-center justify-center skew-x-[20deg] xl:skew-x-[-20deg] relative px-[25px] sm:px-[40px] pr-[85px] 2xl:px-[70px] xl:pr-[40px] py-[25px] sm:py-[45px] sm:pt-[45px] sm:pb-[16px] z-5">
//               <svg
//                 className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//                 width="65"
//                 height="64"
...
//             </div>
//           </div>
//           <div className="bg-advantages skew-x-[20deg] w-full col-span-2 xl:col-span-1">
//             <div className="w-full flex flex-col gap-[16px] items-center justify-center skew-x-[-20deg] relative px-[50px] pr-[75px] 2xl:px-[30px] 2xl:pr-[90px] py-[25px] sm:py-[45px] sm:pt-[45px] sm:pb-[16px] z-5">
//               <svg
//                 className="text-primary-main w-[24px] h-[24px] sm:w-[64px] sm:h-[64px]"
//                 width="64"
//                 height="64"
