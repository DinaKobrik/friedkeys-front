...
const PreOrders = () => {
  ...
  return (
    <div className="my-[40px] md:my-[120px]">
      ...
      <div className=" w-full flex sm:grid overflow-scroll scroll-none sm:overflow-visible sm:grid-flow-row grid-cols-6 sm:grid-cols-2 lg:grid-cols-3 gap-[12px] sm:gap-[24px]">
