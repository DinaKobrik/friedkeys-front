...
const OrderActivation: React.FC = () => {
      ...
      return Array.from({ length: quantity }, (_, index) => {
        ...
        return (
          <div
            ...
            <div
              ...
              <div
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center flex-wrap line-clamp-2 justify-between sm:justify-start w-full gap-[8px] md:gap-[20px] xl:gap-[40px] gap-y-[3px]">
                      ...
                      <span
                        className={`${
                          showKeys[entries[0].cartKey + "-" + index]
                            ? "text-[11px] xs:text-[13px] md:text-[20px] xs:leading-[13px] md:leading-[15px]"
            ...
            <div className="skew-x-[-10deg] sm:skew-x-[-20deg] max-w-[calc(100%-30px)] sm:max-w-[calc(100%-20px)] mx-auto py-[8px] px-[18px] bg-2 flex flex-col md:flex-row justify-between items-center w-full gap-[9px]">
              <div className="flex flex-col lg:flex-row lg:items-center sm:gap-[8px] lg:gap-[24px] skew-x-[10deg] sm:skew-x-[20deg]">
  ...
  return (
    <main>
      <div className="flex ml-[10px] max-w-[251px] mb-[40px] sm:mb-[60px] mt-[40px] sm:mt-[60px] xl:mt-[136px] sm:max-w-[248px]">
        <Button
          variant="secondary"
          className="max-w-[150px] sm:max-w-[251px] ml-0 sm:mx-auto h-[40px] sm:h-[45px] flex items-center justify-center"
          ...
          <div className="w-full xl:w-[288px] xl:px-[12px] flex flex-col gap-[16px]">
            <div className="flex flex-col w-full gap-[20px] pb-[20px] border-b-4 border-[#4C4C4C]">
              <div className="flex w-full justify-between items-center gap-[10px]">
                <span className="uppercase m-0 text-gray-68 font-usuzi-condensed text-[16px] leading-[16px] sm:text-[19px] sm:leading-[20px]">
                  Order
                </span>
            ...
            <div className="flex w-full justify-between items-center gap-[10px] xl:mb-[68px]">
              <span className="uppercase m-0 text-white font-usuzi-condensed text-[20px] leading-[24px] sm:text-[20px] sm:leading-[20px]">
                Total price
              </span>
              <span className="text-white font-bold text-[20px] leading-[24px]">
