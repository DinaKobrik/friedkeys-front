  ...
  const paginatedGames = useMemo(() => {
    ...
    const allCards = uniqueGamesWithCards.flatMap(({ game, entries }) => {
      ...
      return Array.from({ length: quantity }, (_, index) => {
        ...
        return (
          <div
            key={`${entries[0].cartKey}-${index}`}
            className="flex flex-col gap-[4px] sm:gap-[6px] w-full">
            <div
              className="flex w-full items-center gap-[12px] h-[125px] sm:h-[210px]"
              aria-label={`${game.title} ${edition} Activation Card ${
                index + 1
              }`}>
              <div className="card-corner w-full relative flex-shrink-0 h-full max-w-[81px] sm:max-w-[180px] lg:max-w-[320px] mainCustom:max-w-[390px]">
                <div
              ...
              <div
                ...
                <div className="w-full">
                  <div className="grid grid-cols-3 md:grid-cols-4 w-full items-center justify-between gap-[9px] mb-[12px] sm:mb-[17px]">
                    <Heading
                      variant="h3"
                  ...
                  <div className="flex items-center flex-wrap line-clamp-2 justify-between sm:justify-start w-full gap-[8px] md:gap-[20px] xl:gap-[30px] gap-y-[3px]">
                ...
                <div className="flex flex-col bodyCustom:flex-row items-start bodyCustom:items-center w-full gap-[2px] sm:gap-[8px] md:gap-[16px]">
                  <p className="text-white text-[13px] leading-[15px] sm:text-[15px] sm:leading-[19px]">
                    Ready for activation in your Steam Account
                  </p>
                  <div className="bg-3 h-[34px] md:h-[45px] w-auto xs:w-[257px] md:w-[273px] skew-x-[-20deg] py-[8px] px-[10px] md:py-[12px] md:px-[15px] flex justify-center items-center flex-shrink-0">
                    <div className="flex justify-center items-center skew-x-[20deg] gap-[8px] md:gap-[13px]">
                      <span
                        className={`${
                          showKeys[`${entries[0].cartKey}-${index}`]
                            ? "text-[11px] xs:text-[13px] md:text-[15px] xs:leading-[13px] md:leading-[15px]"
                            : "text-[16px] leading-[16px] xs:text-[23px] xs:leading-[23px] md:text-[22px] md:leading-[22px]"
                        }`}>
                        {showKeys[`${entries[0].cartKey}-${index}`]
                          ? activationKey
                          : "•••••• – •••••• – ••••••"}
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className={`cursor-pointer flex-shrink-0 w-[20px] h-[20px] md:w-[24px] md:h-[24px] ${
            ...
            <div className="card-corder skew-x-[-10deg] sm:skew-x-[-20deg] max-w-[calc(100%-30px)] sm:max-w-[calc(100%-20px)] mx-auto py-[8px] px-[18px] bg-2 flex flex-col md:flex-row justify-between items-center w-full gap-[12px]">
              ...
              <div className="flex items-center gap-[31px] skew-x-[10deg] sm:skew-x-[20deg]">
                <button
                  ...
                  <span className="flex items-center gap-[8px] skew-x-[20deg]">
                    <LikeIcon className="rotate-180 w-[24px] h-[24px]" />
                  </span>
                </button>
                <button
                  ...
                  <span className="flex items-center gap-[8px] skew-x-[20deg]">
                    <LikeIcon className="w-[24px] h-[24px]" />
                  </span>
                </button>
              </div>
            </div>
  ...
  return (
    <main>
      ...
      <section className="mb-[56px] md:mb-[90px]">
        ...
        <div className="flex flex-col xl:flex-row gap-[56px] xl:gap-[18px]">
          <div className="flex-1 flex flex-col gap-[12px]">
            {Object.keys(orderItems).length === 0 ? (
              ...
              <>
                ...
                <Text className="mt-[24px] sm:mt-[30px]">
          ...
          <div className="w-full xl:w-[288px] xl:px-[12px] flex flex-col gap-[16px]">
            <div className="flex flex-col w-full gap-[15px] pb-[15px] border-b-4 border-[#4C4C4C]">
              <div className="flex w-full justify-between items-center gap-[8px]">
                ...
                <span className="text-gray-68 font-bold text-[15px] leading-[15px]  sm:leading-[18px]">
                  FK-00000000-0000
                </span>
              </div>
              <div className="flex w-full justify-between items-center gap-[8px]">
              ...
              <div className="flex w-full justify-between items-center gap-[8px]">
                ...
                <span className="text-gray-68 font-bold text-[15px] leading-[15px] sm:leading-[21px]">
                  {orderData?.paymentMethod || "0$"}
                </span>
              </div>
            </div>
            <div className="flex w-full justify-between items-center gap-[8px] xl:mb-[51px]">
              <span className="uppercase m-0 text-white font-usuzi-condensed text-[20px] leading-[24px] sm:text-[21px] sm:leading-[21px]">
                Total price
              </span>
