...
// import ReviewCard from "@/components/Sections/Feedback/FeedbackCard";

// const ReviewsPage: React.FC = () => {
//   return (
//     <div className="mt-[24px] sm:mt-[80px] flex flex-col gap-[24px] sm:gap-[80px]">
//       <div>
//         <Heading
//           variant="h3"
...
//         />
//       </div>
//       <div className="grid grid-cols-2 lg:grid-cols-3 gap-[11px] sm:gap-[24px]">
